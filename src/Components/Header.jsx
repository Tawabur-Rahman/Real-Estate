...
const Header = () => {
  return (
    <div className='min-h-screen md-4 bg-cover bg-center flex items-start w-full overflow-hidden'
      style={{ backgroundImage: "url('/header_img.png')" }} id='Header'
    >
      <Navbar />
      <div className='container text-center my-auto py-4 px-6 md:px-20 lg:px-32 text-white'>
